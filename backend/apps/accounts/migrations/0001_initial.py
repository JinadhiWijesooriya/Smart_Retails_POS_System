    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('Super Admin', 'Super Admin'), ('Admin', 'Admin'), ('Manager', 'Manager'), ('Cashier', 'Cashier'), ('Inventory Officer', 'Inventory Officer')], max_length=50, unique=True)),
